    ...
    <div>
      <center>
        ...
        <img
          height={"500px"}
          width="500px"
          src="https://assets-in.bmscdn.com/discovery-catalog/events/tr:w-400,h-600,bg-CCCCCC:w-400.0,h-660.0,cm-pad_resize,bg-000000,fo-top:l-image,i-discovery-catalog@@icons@@star-icon-202203010609.png,lx-24,ly-615,w-29,l-end:l-text,ie-OC4yLzEwICAxLjRLIFZvdGVz,fs-29,co-FFFFFF,ly-612,lx-70,pa-8_0_0_0,l-end/et00378435-vtzeanzyyd-portrait.jpg"
          alt=""
        ></img>
        <h1>Odavum mudidhu Oliyavum Mudiyadhu</h1>
        <p>Comedy / Harror</p>
        <br></br>
        <p>Rating:4⭐⭐⭐⭐</p>
        <br></br>{" "}
